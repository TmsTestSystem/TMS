...
COPY public.projects (id, name, description, git_repo_url, git_branch, created_by, created_at, updated_at) FROM stdin;
b5c5b2b7-1e52-4600-adcb-c5d2b39adf21	Тест-кейсы СПР	Набор тест-кейсов для тестирования СПР	https://github.com/TmsTestSystem/case_test.git	main	\N	2025-07-31 15:43:50.649209	2025-08-01 11:05:09.445539
\.
...
7d8ec539-0e1d-43c6-8827-b158434050b7	Критический	#EF4444	2025-07-29 16:00:16.983945
9191b159-924f-46ce-a025-b79c8e2d2e92	Высокий	#F59E0B	2025-07-29 16:00:16.983945
904e840f-4803-4ca4-82f8-b704bf2b969f	Средний	#10B981	2025-07-29 16:00:16.983945
58ab3ca0-35ab-4ced-9f4f-c54c95cdd2cf	Низкий	#6B7280	2025-07-29 16:00:16.983945
baedfd15-6163-4ca6-852f-40d174e1b92f	Баг	#DC2626	2025-07-29 16:00:16.983945
f6b33520-0625-4fd4-bda9-93be7d4fa6e8	Улучшение	#2563EB	2025-07-29 16:00:16.983945
\.
...
COPY public.test_case_sections (id, project_id, parent_id, name, order_index, created_at, updated_at) FROM stdin;
e793b543-44d6-419e-8ed1-ffac62b3e507	b5c5b2b7-1e52-4600-adcb-c5d2b39adf21	\N	Вход на платформу	0	2025-07-31 15:44:32.827614	2025-07-31 15:44:32.827614
1d1d263e-745f-43f2-9494-224481b4e56f	b5c5b2b7-1e52-4600-adcb-c5d2b39adf21	e793b543-44d6-419e-8ed1-ffac62b3e507	Восстановление пароля	1	2025-07-31 15:44:59.621934	2025-07-31 15:44:59.621934
45038ee2-9927-40be-b299-3d4d5e00c6d0	b5c5b2b7-1e52-4600-adcb-c5d2b39adf21	\N	Язык выражений	2	2025-08-01 11:05:44.134268	2025-08-01 11:05:44.134268
95e96c84-840b-4f94-8f28-10db98bff94d	b5c5b2b7-1e52-4600-adcb-c5d2b39adf21	45038ee2-9927-40be-b299-3d4d5e00c6d0	Разделения операторов через ;	3	2025-08-01 11:07:12.444091	2025-08-01 11:07:12.444091
\.
...
COPY public.test_plans (id, project_id, name, description, status, created_by, created_at, updated_at) FROM stdin;
\.
...
COPY public.test_runs (id, test_plan_id, name, description, status, started_by, started_at, completed_at, created_at) FROM stdin;
\.
...
00000000-0000-0000-0000-000000000001	admin	admin@spr.com	$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2uheWG/igi.	Администратор	Системы	admin	2025-07-29 16:00:16.981172	2025-07-29 16:00:16.981172
\.
...
--
-- Name: idx_comments_entity; Type: INDEX; Schema: public; Owner: tms_user
--
...
--
-- Name: idx_test_cases_project_id; Type: INDEX; Schema: public; Owner: tms_user
--
...
--
-- Name: idx_test_cases_test_plan_id; Type: INDEX; Schema: public; Owner: tms_user
--
...
--
-- Name: idx_test_results_test_case_id; Type: INDEX; Schema: public; Owner: tms_user
--
...
--
-- Name: idx_test_results_test_run_id; Type: INDEX; Schema: public; Owner: tms_user
--
...
--
-- Name: checklist_items checklist_items_checklist_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tms_user
--
...
--
-- Name: checklist_results checklist_results_checklist_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tms_user
--
...
--
-- Name: SCHEMA public; Type: ACL; Schema: -; Owner: tms_user
--
